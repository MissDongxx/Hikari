...
export default function FeaturesHover() {
  return (
    <section
      id="features"
      className="container scroll-mt-28 space-y-6 bg-zinc-50 py-8 dark:bg-zinc-900 md:py-12 lg:py-24 rounded-6xl mb-10"
    >
      ...
      <div className="mx-auto text-center md:max-w-[58rem]">
        {/* <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          Saas-Starter also includes a blog and a full-featured documentation site
